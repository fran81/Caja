...
<div class="cotizacions index">
	...
	?>
	<tr<?php echo $class;?>>
		<td><?php echo $cotizacion['Cotizacion']['fecha_desde']; ?>&nbsp;</td>
		<td><?php echo $cotizacion['Cotizacion']['fecha_hasta']; ?>&nbsp;</td>
		<td><?php echo $cotizacion['Cotizacion']['importe']; ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($cotizacion['Moneda']['nombre'], array('controller' => 'monedas', 'action' => 'view', $cotizacion['Moneda']['id'])); ?>
		</td>
		<td class="actions">
			<?php echo $this->Html->link(__('Ver', true), array('action' => 'view', $cotizacion['Cotizacion']['id']),array('class'=>'ver')); ?>
			<?php echo $this->Html->link(__('Editar', true), array('action' => 'edit', $cotizacion['Cotizacion']['id']),array('class'=>'editar')); ?>
			<?php echo $this->Html->link(__('Borrar', true), array('action' => 'delete', $cotizacion['Cotizacion']['id']),array('class'=>'borrar'), sprintf(__('Está seguro que desea borrar # %s?', true), $cotizacion['Cotizacion']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
