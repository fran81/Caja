...
<?php echo $this->Form->create('Operacion');?>
	<fieldset>
		<legend><?php __('Edit Operacion'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('Operacion.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('Operacion.id'))); ?></li>
